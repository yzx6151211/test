...
class xls_xlsx:
    def __init__(self,file_name):
        ...
        self.rootdir = r"C:\Users\Administrator\Downloads"  # 需要转换的xls文件存放处
        self.rootdir1 = r"C:\Users\Administrator\Downloads"  # 转换好的xlsx文件存放处
...
class Xls_out:
    ...
    def out_ret(self):
        ...
        #print(data1)
        data1.to_excel(r'C:\Users\Administrator\Downloads\1.xlsx', sheet_name='Sheet1', index=None, encoding="gbk")
        print("*"*100)
        data1= self.df_inner.query('二 == ["大份", "小份"]')
        data1["行政服务中心人力社保窗口午餐统计表"] = range(1, len(data1) + 1)

        #print(data1)
        data1.to_excel(r'C:\Users\Administrator\Downloads\2.xlsx', sheet_name='Sheet1', index=None, encoding="gbk")

        data1= self.df_inner.query('三 == ["大份", "小份"]')
        data1["行政服务中心人力社保窗口午餐统计表"] = range(1, len(data1) + 1)

        #print(data1)
        data1.to_excel(r'C:\Users\Administrator\Downloads\3.xlsx', sheet_name='Sheet1', index=None, encoding="gbk")

        data1= self.df_inner.query('四 == ["大份", "小份"]')
        data1["行政服务中心人力社保窗口午餐统计表"] = range(1, len(data1) + 1)

        #print(data1)
        data1.to_excel(r'C:\Users\Administrator\Downloads\4.xlsx', sheet_name='Sheet1', index=None, encoding="gbk")

        data1= self.df_inner.query('五 == ["大份", "小份"]')
        data1["行政服务中心人力社保窗口午餐统计表"] = range(1, len(data1) + 1)

        #print(data1)
        data1.to_excel(r'C:\Users\Administrator\Downloads\5.xlsx', sheet_name='Sheet1', index=None, encoding="gbk")
class Xls_set:
    def __init__(self,file_name):
        ...
        for a in range(1, 6):
            excelPath = "C:\\Users\\Administrator\\Downloads\\"+str(a)+".xlsx"
            ...
            excelBook.save("C:\\Users\\Administrator\\Downloads\\"+"人力社保窗口"+name_xls[5:7]+"月"+name_xls[8:10]+"日"+"中餐统计"+".xlsx")
            a+=1
